...
export default function AdminDashboard(){
  ...
  async function genQR(){
    try {
      ...
      const margin = 36; const cellW = 260, cellH = 260; const cols = 2;
      ...
      for (const row of batch){
        ...
        const url = `${prefix}?unit_id=${uid}&name=${name}&token=${tok}`;
      ...
      await supabase.from('vote_audit').insert({ action:'qr_generate', details:{ count: batch.length, expires_at: expires, pdf:true, url:true } });
      ...
      <section className="card">
        <div className="row" style={{justifyContent:'space-between'}}>
          ...
          <div className="toolbar">
            ...
            <button className="btn" onClick={genQR}>Generate QR Tokens (14 days) + PDF</button>
          </div>
        </div>
