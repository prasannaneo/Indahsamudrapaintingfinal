...
export default function AdminDashboard(){
  ...
  async function genQR(){
    try {
      ...
      const list = (r||[]).map(x=>x.unit_id).filter(Boolean);
      ...
      const payload = list.map(u=>({ token: crypto.randomUUID(), unit_id: u, expires_at: expires }));
      ...
      alert('Generated '+payload.length+' QR tokens.');
    } catch(e){
