...
export default function AdminLogin(){
  ...
  return (<div className="grid" style={{gap:8, maxWidth:380}}>
    <h2>Admin Login</h2>
    <input className="card" placeholder="Username" value={u} onChange={e=>setU(e.target.value)}/>
    <input className="card" placeholder="Password" type="password" value={p} onChange={e=>setP(e.target.value)}/>
