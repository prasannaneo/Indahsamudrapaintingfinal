...
function AdminShell({ title, children }){
  return (<div className="container">
    ...
    <style>{`.panel{padding:12px;border:1px solid #e5e7eb;border-radius:12px;background:#fff;margin:10px 0}.btn{padding:10px 14px;border:1px solid #e5e7eb;border-radius:12px;background:#f8fafc;cursor:pointer}.btn.primary{background:#0ea5e9;color:#fff;border-color:#0ea5e9}.input{padding:10px;border:1px solid #e5e7eb;border-radius:10px}.container{max-width:1100px;margin:0 auto;padding:24px}.link{color:#0ea5e9}`}</style>
  </div>);
}
